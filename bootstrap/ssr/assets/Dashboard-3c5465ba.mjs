import { Search } from "vant/es/index.mjs";
...
const _sfc_main = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="w-full h-full pt-4 px-4 pb-24 bg-gray-200 flex flex-col">`);
      _push(ssrRenderComponent(_component_van_search, {
        ...
        action: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              createVNode("div", { onClick: _ctx.onClickButton }, "搜索", 8, ["onClick"])
            ];
          }
        }),
        _: 1
